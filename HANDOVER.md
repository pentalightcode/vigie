...
- **PRIORITÉ N°1 — tester le chantier collaboration en conditions réelles** (déployé le 31/08/2026, jamais encore utilisé par de vrais comptes) : voir section 8 pour l'incertitude technique précise à vérifier en premier (`estParticipant()`/`Filter.or()`), plus un test de bout en bout du flux d'invitation et du digest quotidien pour un participant non-propriétaire.

...
**Un autre agent lit ce même contenu au format `AGENTS.md`** (lu par Antigravity, Cursor, Windsurf et la plupart des outils non-Claude) — les deux fichiers doivent rester en miroir, mettre à jour l'un implique de mettre à jour l'autre.
